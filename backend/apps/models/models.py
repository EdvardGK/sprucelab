...
class Model(models.Model):
    ...
    # Server-side PNG snapshot (512×512) generated by ifc-service during
    # fragment generation. Used for model cards in the frontend before the
    # 3D viewer loads. Nullable — older models without a generated thumbnail
    # show a fallback icon.
    thumbnail_url = models.URLField(
        max_length=500,
        blank=True,
        null=True,
        help_text="URL to PNG thumbnail image generated from the IFC model",
    )
