 ...
 * Requirements:
 *   - Node.js 18+
 *   - @thatopen/components package installed in this directory
 *
 * This script is called by FastAPI backend (api/fragments.py)
...
async function convertToFragments(inputPath, outputPath) {
  ...
  try {
    ...
    // Script location: ifc-service/scripts/convert-to-fragments.mjs
    // WASM location: ifc-service/scripts/node_modules/web-ifc/
    ...
    // Output JSON result for parsing by caller
