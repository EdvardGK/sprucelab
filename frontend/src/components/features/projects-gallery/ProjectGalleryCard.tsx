...
/**
 * Single project tile rendered in the gallery grid. Fixed 180px height
 * card with: name, relative-time, tiny KPI strip (models / instances /
 * last activity), and an IFC discipline sparkbar at the bottom.
 *
 * Per the audit: no 3D thumbnails (WebGL context limit), no
 * `hover:shadow-glow`, no scale transform — hover affords via a border
 * tint only.
 */
